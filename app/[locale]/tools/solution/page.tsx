...
import { Shield, Rocket, Zap, Lock, Eye } from "lucide-react";
import { useTranslations } from "next-intl";

const solutions = [
  { id: "openclaw-iac", key: "openclaw", icon: Shield, path: "/tools/solution/openclaw-iac", tags: ["IaC", "Terraform", "OCI", "Security"] },
  ...
  { id: "augentrainer", key: "augentrainer", icon: Eye, path: "/tools/solution/augentrainer", tags: ["Eye Training", "Focus", "Neuro-Visual", "Health"] },
];
  ...
  return (
    <section className="container" style={{ paddingTop: "8rem", paddingBottom: "4rem" }}>
      <h1 style={{ fontSize: "2.5rem", marginBottom: "3rem" }}>
        {t("solutionsTitle").split("Solutions")[0]}
        ...
        {solutions.map((sol) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-8 flex-1 relative z-10" style={{ paddingLeft: isHovered ? "10px" : "0", transition: "all 0.3s ease" }}>
                {t(`${sol.key}.tagline`)}
              </p>
