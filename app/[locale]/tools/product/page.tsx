  ...
  return (
    <section className="container" style={{ paddingTop: "8rem", paddingBottom: "4rem" }}>
      <h1 style={{ fontSize: "2.5rem", marginBottom: "3rem" }}>
        {t("productsTitle").split("Products")[0]}
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4 relative z-10">
                ...
                {!isAvailable && (
                  <span className="px-2 py-1 text-[10px] uppercase tracking-wider font-bold bg-amber-500/20 text-amber-400 rounded border border-amber-500/20">
                    {t("comingSoon")}
                  </span>
                )}
              </div>

              <p className="text-slate-400 text-sm leading-relaxed mb-8 flex-1 relative z-10">{t(`${product.id}.description`)}</p>
