...
const teamMembers = [
  {
    ...
    skills: ["VMware", "AWS", "Kubernetes", "AI/ML"],
    avatar: "https://ui-avatars.com/api/?name=Jürgen+Müller&background=5b9bd5&color=fff&size=256",
    github: "https://github.com/foozy74",
    github2: "https://github.com/jmueller-bit",
    linkedin: "https://www.linkedin.com/in/jürgen-müller-b4792a57",
  },
  {
    name: "Moritz Müller",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {"github2" in member && member.github2 && (
          <a
            href={member.github2 as string}
            target="_blank"
            rel="noopener noreferrer"
            style={{
              color: "var(--text-secondary)",
