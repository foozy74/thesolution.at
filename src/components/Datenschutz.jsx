  ...
  return (
    <section className="container" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
      ...
      <div className="glass" style={{ padding: '3rem', marginBottom: '2rem' }}>
        <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: 'var(--accent-teal)' }}>
          1. Verantwortlicher
        </h3>
        ...
        <div style={{ 
          ...
          <p style={{ color: 'var(--text-secondary)' }}>
            E-Mail: <a href="mailto:contact@thesolution.at" style={{ color: 'var(--accent-teal)', textDecoration: 'none' }}>contact@thesolution.at</a><br />
      ...
      <div className="glass" style={{ padding: '3rem', marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, marginTop: '1rem' }}>
          ...
          E-Mail: <a href="mailto:dsb@dsb.gv.at" style={{ color: 'var(--accent-teal)', textDecoration: 'none' }}>dsb@dsb.gv.at</a>
        </p>
      </div>
